...
to `s3://<PROVIDED_BUCKET_NAME>/snapshots/keyspace_prefix/table_prefix/[0-7]/[insert|update|delete]/YYYY-MM-HHTMM:SS:ss.sss`.

```shell
./cqlreplicator --cmd run --max-wcu-traffic 20000 --landing-zone "s3://<PROVIDED_BUCKET_NAME>" --env parquet \
