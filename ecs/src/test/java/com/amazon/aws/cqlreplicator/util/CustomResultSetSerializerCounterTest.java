...
class CustomResultSetSerializerCounterTest {
 ...
 */
    ...
    @Test
    void testCounterType() throws Exception {
        ResultSet expected = session.execute("select col3 from test_counter WHERE col1='TEST1' and col2=1");
        ResultSet actual = session.execute("select json col3 from test_counter WHERE col1='TEST1' and col2=1");
