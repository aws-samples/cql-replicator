...
public class CqlReplicatorTest {
    ...
    private static final CqlSession keyspacesConnectorSession =
            CqlSession.builder()
    ...
    private static final CqlSession cassandraConnectorSession =
            CqlSession.builder()
    ...
    private static final Set<String> sourceHash = new HashSet<>();
    private static final Set<String> targetHash = new HashSet<>();
